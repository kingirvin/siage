...

{
	...
	public function VerificarDocenteCurso($vars)
...

	{
		...
		$this->consulta="SELECT tdocente.idDocente as idDocente,CONCAT(tpersona.Nombre,' ',tpersona.Apellido) as Nombre from tdocente inner join tpersona on tdocente.DNI=tpersona.DNI;";
...
//		echo $this->consulta;
	...
	public function ListarDocenteCursoCarga($vars)
		{
			$this->consulta="call spVerificarDocenteCarga(".$vars['idCarga'].",".$vars['idCurso_Semestre'].");";
			$this->Consultar();	
			//echo $this->consulta;
			return $this->rows;	
		}
