...
{    
    $("#Area").kendoComboBox({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/Recursos/Datos.php?Modulo=Curso&Accion=ListarArea&Pagina=0&Size=100",
                }
            },
            schema: 
            {
...
{    
    $("#Ciclo").kendoComboBox({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/Recursos/Datos.php?Modulo=Carrera&Accion=ListarCiclo&Pagina=0&Size=100",
                }
            },
            schema: 
            {
...
{    
    $("#Modulo").kendoComboBox({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/Recursos/Datos.php?Modulo=Carrera&Accion=ListarModulo&Pagina=0&Size=100",
                }
            },
            schema: 
            {
...
{    
    $("#Cursos").kendoComboBox({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/Recursos/Datos.php?Modulo=Curso&Accion=Listar&Pagina=0&Size=100",
                }
            },
            schema: 
            {
...
{   
   var dataString={idArea:document.getElementById("Area").value,
    ...
    $.ajax({
          type: "POST",
            url: "/Recursos/Datos.php?Modulo=Curso&Accion=RegistrarCurso&Pagina=0&Size=100",
            data: dataString,
            cache:false,
...
{   
   var dataString={Carrera:document.getElementById("Carrera").value,
    ...
    $.ajax({
          type: "POST",
            url: "/Recursos/Datos.php?Modulo=Curso&Accion=RegistrarCursoCliclo&Pagina=0&Size=100",
            data: dataString,
            cache:false,
          success: function (result) 
          {    
