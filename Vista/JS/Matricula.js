function BuscarEstudiante() {
  ...
  $.ajax({
    type: "POST",
    url: "/Recursos/Datos.php?Modulo=Persona&Accion=BuscarEstudiante&Pagina=0&Size=100",
    data: dataString,
    cache:false,
...
function BuscarMatriculaEstudiante(sd) { 
    ...
    $.ajax({
      type: "POST",
      url: "/Recursos/Datos.php?Modulo=Curso&Accion=ListaCursosCiclo&Pagina=0&Size=100",
      data: dataString,
      cache:false,
      success: function (data) {  
        /*if(data.length>0)
...
function buscarPeriodo() {
    ...
    $.ajax({
      type: "POST",
      url: "/Recursos/Datos.php?Modulo=Periodo&Accion=BuscarPeriodo&Pagina=0&Size=100",
      data: dataString,
      cache:false, 
      success: function (data) {
      	var dats = data;
...
function guardar() {
  ...
  $.ajax({
      type: "POST",
      url: "/Recursos/Datos.php?Modulo=Matricula&Accion=RegistrarMatricula&Pagina=0&Size=100",
      data: dataString,
      cache:false,
