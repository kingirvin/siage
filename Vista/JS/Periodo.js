...
{    
    $("#Carrera").kendoComboBox({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/Recursos/Datos.php?Modulo=Carrera&Accion=Listar&Pagina=0&Size=100",
                }
            },
            schema: 
            {
...
{    
    $(".Docente").kendoComboBox({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/Recursos/Datos.php?Modulo=Persona&Accion=ListarDocente&Pagina=0&Size=100",
                }
            },
            schema: 
            {
...
{  
  var dataString;
    $.ajax({
          type: "POST",
            url: "/Recursos/Datos.php?Modulo=Periodo&Accion=UltimoPeriodo&Pagina=0&Size=100",
            data: dataString,
            cache:false,
...
function RegistrarPeriodo()
{
   var dataString={Nombre:document.getElementById("Nombre").value};
    $.ajax({
          type: "POST",
            url: "/Recursos/Datos.php?Modulo=Periodo&Accion=Registrar&Pagina=0&Size=100",
            data: dataString,
            cache:false,
          success: function (data) 
          {       
...
{  
    ...
    $.ajax({
      type: "POST",
      url: "/Recursos/Datos.php?Modulo=Carga&Accion=ListarCursoCarga&Pagina=0&Size=100",
      data: dataString,
      cache:false,
      success: function (data) 
      { 
          ...
          for (var dato in data["data"]) {  
              lista.append("<form onsubmit='return false;'>"+
                            "<div class='list-group-item'>"+
                              "<div>"+data["data"][dato]["Nombre"]+""+
                                ...
                                "</span>"+
                                "<input type='hidden' name='idCarga' value='"+data["data"][dato]["idCurso_Semestre"]+"'>"+
                                ...
                                "<div class='panel-body'>"+
                                  "<div class='btn-group'>"+
                                    "<div class='form-group'>"+
                                      ...
                                      "<div class='col-sm-10'>"+
                                        "<input  class='Docente' name='Docente' style='width: 400px'/><button type='submit' class='btn btn-theme'onclick='AgregarCursoCarga(this);'>AGREGAR</button>"+
                                      "</div>"+
                                    "</div>"+                                    
                                  "</div>"+
                                "</div>"+
...
function AgregarCursoCarga(sd)
{
  ...
  $.ajax({
      ...
      url: "/Recursos/Datos.php?Modulo=Carga&Accion=RegistrarCursoCarga&Pagina=0&Size=100",
